              ...
              <span className="text-2xl font-bold text-red-500">
                {(product.pricePromo || product.price)?.toLocaleString()}đ
                            ...
                            {product.pricePromo && product.price && (
                                <>
                                    <span
                                        className="text-gray-400 line-through">{product.price.toLocaleString()}đ</span>
                        ...
                        <div className="mt-2">
                            {selectedSize && selectedColor ? (
                                selectedColor.stock > 0 ? (
                                    <p className="text-blue-600 font-medium">Tình trạng: Còn hàng
                                        ({selectedColor.stock})</p>
                                ) : (
                                ...
                                <li key={cmt._id} className="p-3 border rounded-lg bg-gray-100">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1">
                                            <span
                                                className="font-bold text-blue-600">{cmt.user.name || "Ẩn danh"}</span>
                                                            ...
                                                            {cmt.replies.map((reply) => (
                                                                <li key={reply.id} className="border-l-2 pl-2">
                                                                    <div className="flex items-start gap-2">
                                                                        ...
                                                                        <div>
                                                                            <span
                                                                                className="font-bold text-blue-600">{reply.username}</span>
                                                                            <p className="text-gray-800">{reply.content}</p>
                                                                            <span
                                                                                className="text-gray-500 text-sm">{reply.time}</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            ))}
