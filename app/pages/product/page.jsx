  ...
  return (
    <div className="flex justify-center align-middle">
      <div className="min-h-[100vh] max-w-[1440px] flex gap-[2%] my-32">
        <div className="w-[25%]">
          <div className="min-w-[100px] text-gray-900 flex gap-5 align-middle items-center bg-gradient-to-r from-cyan-500 via-gray-800/50 to-blue-400 py-3 px-2 rounded-lg h-[72px]">
        ...
        <div className="w-[75%]">
          ...
          min-h-[58px] items-center 
          bg-gradient-to-r from-cyan-500 via-gray-800/50 to-blue-400
          rounded-lg 
          py-3 
          px-2">
            <div className="w-[10%]">
