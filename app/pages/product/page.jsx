...
import SearchComponent from "@/app/components/product/search";
import DropDown from "@/app/components/product/dropdown";
import Product from "@/app/components/product";
import Pagination from "@/app/components/product/pagination";
import Sidebar from "@/app/components/product/sidebar";
import PriceRange from "@/app/components/product/processBar";
        ...
        <div className="flex justify-center bg-gray-100 min-h-screen">
            <div className="w-full max-w-[1920px] flex flex-col lg:flex-row gap-6 my-6 px-[100px] lg:my-20">
                ...
                <div className="w-full lg:w-[75%]">
                    <div
                        className="bg-gradient-to-r from-blue-400 to-blue-600 text-white py-4 px-5 rounded-lg shadow-md">
