...
import type CartState from "../app/models/CartState"
...
export default function Home() {
    ...
    return (
        <div>
            <div className="m-[48px]">
                ...
                {data.map((product: Product) => (
                    ...
                    {product.priceSale}
                        ...
                        <button
                            onClick={() => handleAdd({...product, selectedSize: selectedSize, quantity: 1})}
                        >
                            Mua
                        </button>
                    </div>
            ...
            {/*</div>*/}
            {/*<div*/}
            {/*    className="text-gray-900 mx-5 my-5 py-8 flex justify-between items-center border-b-4 border-b-gray-900">*/}
            ...
            {/*        </p>*/}
            {/*        <button*/}
            {/*            className="bg-transparent hover:bg-gray-500 text-gray-900 font-semibold hover:text-white py-2 px-4 border border-gray-900 hover:border-transparent rounded">*/}
            {/*            Button*/}
            {/*        </button>*/}
            {/*    </div>*/}
            {/*</div>*/}
